<script setup>
/**
 * @file AltaUsuarioView.vue
 * @description Módulo de administración para registrar y gestionar cuentas de acceso web.
 * Permite enlazar nuevas credenciales con registros de docentes existentes y 
 * actualizar contraseñas mediante un modal seguro. Exclusivo para administradores.
 */
...
// Estado para Modal de Actualización de Contraseña
...
/**
 * Solicita a la API la lista completa de usuarios autorizados.
 * Usado para popular la tabla del directorio inferior.
 */
...
/**
 * Resetea todos los campos del formulario de registro y limpia alertas visuales.
 */
...
/**
 * Valida contraseñas, empaqueta el payload y envía la solicitud POST
 * para crear un nuevo usuario y enlazarlo con su matrícula de docente.
 */
const registrar = async () => {
  ...
  try {
    ...
    delete datosEnvio.confirmPassword; // Evita enviar datos redundantes a Django
    ...
    cargarDirectorio(); // Sincroniza la tabla de inmediato
    ...
    // Extracción inteligente de errores de validación de Django
...
/**
 * Pre-carga los datos del usuario seleccionado en la estructura del modal
 * antes de que se visualice en pantalla.
 * @param {Object} user - Objeto de datos del usuario seleccionado en la tabla.
 */
...
/**
 * Envía la solicitud PATCH al servidor para sobrescribir el hash
 * de la contraseña del usuario seleccionado. Cierra el modal automáticamente.
 */
...
<template>
  <div class="container-fluid px-4 py-4">
    ...
    <HeaderInstitucional 
        ...
        subtitulo="Alta y administración de credenciales de acceso al sistema."
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <form @submit.prevent="registrar">
                        ...
                        <div class="d-flex justify-content-end gap-3 mt-4 pt-3 border-top">
                            <button type="button" class="btn btn-light fw-semibold text-secondary px-4 shadow-sm" @click="limpiarFormulario" :disabled="cargandoRegistro">
                ...
                <div class="modal-body px-4 py-4">
                    ...
                    <form @submit.prevent="guardarNuevaPassword">
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            <button type="button" class="btn btn-light fw-semibold text-secondary me-2 shadow-sm" data-bs-dismiss="modal">Cancelar</button>
